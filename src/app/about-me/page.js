  ...
  const words = [
    ...
    <div className='flex flex-col justify-center'>
     ...
     <div className="lg:px-[250px] max-lg:px-[20px] py-20 bg-red-600">
      <h1 className='font-Futura-PT-Bold text-2xl font-bold my-10 text-white'>Personal Values</h1>
      <h2 className='font-Futura-PT text-l my-5 font-semibold text-white'>📖 Eternal Learner.</h2>
      ...
      <h2 className='font-Futura-PT text-l my-5 font-semibold text-white'>🖌️ Creativity Unleashed.</h2>
      <p className="font-Futura-PT text-m mb-10 text-white">
      ...
      <h2 className='font-Futura-PT text-l my-5 font-semibold text-white'>🙏 Humble to the Core.</h2>
      <p className="font-Futura-PT text-m mb-10 text-white">
     ...
     <div className="lg:px-[250px] max-lg:px-[20px] my-20">
      <h1 className='font-Futura-PT-Bold text-2xl my-10'>Let's Craft Together</h1>
      <p className="font-Futura-PT text-m my-10">
