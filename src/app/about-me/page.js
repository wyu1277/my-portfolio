...
export default function AboutMe() {
    ...
    <div className='flex flex-col justify-center'>
     <div className="lg:px-[250px] max-lg:px-[20px] mb-20">
      <h1 className='text-3xl font-bold my-10'>Why WhyDesigns?</h1>
      <p className="text-sm my-10">I'm a creative designer and a code enthusiast who's on a mission to infuse life into every digital experience. In my world, it's all about answering the "why" behind every design choice. I'm not just a designer; I'm a relentless researcher. I believe that great design stems from solid research, and I weave this philosophy into every project I tackle. Curiosity fuels creativity, and every pixel I place serves a purpose. Whether it's crafting an intuitive user interface or weaving a brand's narrative, I'm all about making every pixel count.</p>
     ...
     <div className="lg:px-[250px] max-lg:px-[20px] py-20 bg-red-600">
      <h1 className='text-3xl font-bold my-10 text-white'>Personal Values</h1>
      <h2 className='text-xl my-5 font-semibold text-white'>📖 Eternal Learner.</h2>
      ...
      <h2 className='text-xl my-5 font-semibold text-white'>🖌️ Creativity Unleashed.</h2>
      <p className="text-sm mb-10 text-white">
      ...
      <h2 className='text-xl my-5 font-semibold text-white'>🙏 Humble to the Core.</h2>
      <p className="text-sm mb-10 text-white">
     ...
     <div className="lg:px-[250px] max-lg:px-[20px] my-20">
      <h1 className='text-3xl font-bold my-10'>Let's Craft Together</h1>
      <p className="text-sm my-10">
