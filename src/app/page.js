  ...
  return (
   ...
   <div className='flex justify-center items-center relative'>
      ...
      <div className='absolute flex flex-col justify-center items-center mt-10'>
        ...
        <h1 className='font-Futura-PT lg:text-5xl font-extrabold text-red-600 lg:my-2 max-lg:text-2xl'>a Product Designer & Developer</h1>
   ...
   <h2 className='lg:px-[450px] pt-[40px] max-lg:px-[20px] font-Futura-PT text-gray-600'>MY RECENT WORK</h2>
   <div className='flex flex-col justify-between items-center bg-white lg:px-[450px] max-lg:px-[20px]'>
    <Link href='/le-waf'>
    ...
    <Image priority src={PBanner} className=' lg:my-5 max-lg:my-2 hover:scale-105 transform transition-transform duration-300 ease-in-out hover:shadow-2xl'/>
    </Link>
   </div>
   </>
  )
